...
public class SysUser extends BaseEntity
{
    ...
    /** 是否冻结：0为冻结，1为未冻结 */
    @Excel(name = "是否冻结：0为冻结，1为未冻结")
    private String isLocked;

    /** 是否内置：0为内置，1为非内置 */
    @Excel(name = "是否内置：0为内置，1为非内置")
    private String isBuiltin;

    /** 是否未首次登录0为是，1为否 */
    @Excel(name = "是否未首次登录0为是，1为否")
    private String googleAuthEnabled;

    /** 谷歌验证密钥，用于生成二维码 */
    @Excel(name = "谷歌验证密钥，用于生成二维码")
    ...
    public String getGoogleAuthEnabled() {
        return googleAuthEnabled;
    }

    public void setGoogleAuthEnabled(String googleAuthEnabled) {
