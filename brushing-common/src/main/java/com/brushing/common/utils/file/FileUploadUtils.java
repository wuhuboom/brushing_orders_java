package com.brushing.common.utils.file;
...
import com.brushing.common.exception.file.FileNameLengthLimitExceededException;
import com.brushing.common.exception.file.FileSizeLimitExceededException;
import com.brushing.common.exception.file.InvalidExtensionException;
import com.brushing.common.utils.DateUtils;
import com.brushing.common.utils.StringUtils;
import com.brushing.common.utils.uuid.IdUtils;
import com.brushing.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = BrushingConfig.getProfile();
    ...
    {
        int dirLastIndex = BrushingConfig.getProfile().length() + 1;
