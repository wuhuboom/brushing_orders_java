...
import com.brushing.framework.init.DatabaseInitializer;
...
public class SysIndexController {
    ...
    public String index() {
        ...
        return StringUtils.format("version：{},time-zone：{},time：{}", DatabaseInitializer.version, systemZoneId, formattedDate);
    }
